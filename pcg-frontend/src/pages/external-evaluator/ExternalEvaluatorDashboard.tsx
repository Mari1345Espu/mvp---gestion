...
const ExternalEvaluatorDashboard = () => {
  const { user } = useAuth();
              ...
              {mockEvaluations.map((evaluation) => (
                <ListItem key={evaluation.id}>
                  ...
                  <ListItemSecondaryAction>
                    ...
                    <Button
                      component={RouterLink}
                      to={`/external-evaluator/evaluate/${evaluation.id}`}
                      size="small"
                    >
                      Evaluar
                    </Button>
...
export default ExternalEvaluatorDashboard; 