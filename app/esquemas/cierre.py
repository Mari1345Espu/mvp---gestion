...
class CierreBase(BaseModel):
    ...
    tipo_cierre: constr(min_length=3, max_length=50)  # "proyecto" o "convocatoria"
...
class Cierre(CierreBase):
    ...
    dias_desde_cierre: Optional[int] = None
...
class CierreEstadisticas(BaseModel):
    total_cierres: int
    ...
    cierres_completados: int
    cierres_en_proceso: int
